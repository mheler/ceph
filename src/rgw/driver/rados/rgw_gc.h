...
public:
  int guard_clear(const std::string& tag, const std::string& key, optional_yield y);
  int guard_exists(const std::string& key, const std::string& expected_tag, bool *result, optional_yield y);
